...
namespace Hardcodet.Wpf.TaskbarNotification.Interop
{
    ...
    public struct NotifyIconData
    {
        ...
        /// </summary>
        public NotifyIconVersion VersionOrTimeout;
        ...
        public static NotifyIconData CreateDefault(IntPtr handle)
        {
            ...
            else
            {
                ...
                data.cbSize = (uint)Marshal.OffsetOf(data.GetType(), "TaskbarIconGuid").ToInt32();

                //set to fixed timeout
                data.VersionOrTimeout = (NotifyIconVersion)10;
            }

            data.WindowHandle = handle;
            data.TaskbarIconId = 0x0;
            data.CallbackMessageId = WindowMessageSink.CallbackMessageId;
            data.VersionOrTimeout = NotifyIconVersion.Win95;
